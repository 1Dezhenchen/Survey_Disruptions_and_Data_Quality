...
# Select important columns from both metadata and model variables
important_columns <- c(
  "dataset_title", "ess_round", "edition_number", "production_date", "country", "respondent_id",
  ...
  "interviewer_age", "interviewer_gender", "question_clarification",
...
analysis_data_selected |>
  ...
  kable(booktabs = TRUE, align = "c", col.names = c(
    "Dataset Title", "ESS Round", "Edition Number", "Production Date", "Country", "Respondent ID",
    "Interview Method", "Partner Interference", "Child Interference", "Parent Interference",
    "Relative Interference", "Non-relative Interference", "Interviewer Age",
    "Interviewer Gender", "Question Clarification", "Respondent Reluctant", "Respondent Tried Best"
  )) %>%
